    ...
    <div class="container my-5 p-4 mb-0">
        <div class="row justify-content-center">
            <div class="col-12 text-center">
                <h2 class="displayTitle">Intermediate City's Data (Display)</h2>
            </div>
        </div>
    </div>

   <div class="container">
        <button class="btn btn-warning my-5"><a href="./interCity.php"
                class="text-dark">Add intermediate City</a>
        </button>
    </div>
    <div class="table-container">
        <table class="table table-hover my-bottom-5 table-custom">
            <thead>
                <tr>
                <th scope="col">Intermediate City's ID</th>
            ...
            $sql = "SELECT * FROM IntermediateCity";
